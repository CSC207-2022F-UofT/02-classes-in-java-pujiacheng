...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param string1 the name for first part of the instance.
     * @param string2 the name for second part of the instance.
     *
     */
    ...
    public static void main(String[] args) {
        ...
        /**
         * Below are a bunch of calls to countStatic using
